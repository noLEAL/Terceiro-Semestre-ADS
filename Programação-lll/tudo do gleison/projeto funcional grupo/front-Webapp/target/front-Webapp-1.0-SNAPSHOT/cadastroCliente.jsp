...
<html>
    ...
    <body>
        <div id="principal">
            ...
            <div id="texto">
                <h1>Cadastros</h1>
                <form id="formulario" action="http://localhost:8080/back-Webapp/webresources/backSeparado/cadastro" method="POST">
                    <label for="nome">Nome:</label><br>
                    <input type="text" id="nome" name="nome" maxlength="100" required><br>
                     
                    
                    <label for="data_nascimento">Data de Nascimento:</label><br>
                    <input type="text" id="data_nascimento" placeholder="dd/mm/ano" name="data_nascimento" maxlength="8" oninput="mascaraNacimento(this, 'nascimento')" required><br>
