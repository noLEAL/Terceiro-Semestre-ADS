...
<html>
    ...
    %>
    <body onload="salvarCliente(<%= request.getParameter("id")%>, '<%= request.getParameter("nome")%>', <%= request.getParameter("dataNascimento")%>, '<%= request.getParameter("cpf")%>', '<%= request.getParameter("rg")%>', '<%= request.getParameter("orgaoEmissor")%>', '<%= request.getParameter("sexo")%>', '<%= request.getParameter("email")%>', '<%= request.getParameter("telefone")%>', '<%= request.getParameter("whats")%>', '<%= request.getParameter("logradouro")%>', '<%= request.getParameter("numero")%>', '<%= request.getParameter("bairro")%>', '<%= request.getParameter("cidade")%>', '<%= request.getParameter("estado")%>', '<%= request.getParameter("cep")%>', '<%= acao%>');">
